...
% Back toe
Force3 = f_holConstrImpactForce_toebottomrightback([q,Fimp3]);
velConstr3 = f_holConstrVelocity_toebottomrightback([q,dq_end]);

% Front toe
Force4 = f_holConstrImpactForce_toebottomrightfront([q,Fimp4]);
velConstr4 = f_holConstrVelocity_toebottomrightfront([q,dq_end]);
