...
% Back toe
J3 = zeros(nFe3,3*DOF);
J3 = call_mathematica_Jacobian('holConstrAcceleration_toebottomleftback', J3, [q,dq,ddq], 0);

% Front toe
J4 = zeros(nFe4,3*DOF);
J4 = call_mathematica_Jacobian('holConstrAcceleration_toebottomleftfront', J4, [q,dq,ddq], 0);
