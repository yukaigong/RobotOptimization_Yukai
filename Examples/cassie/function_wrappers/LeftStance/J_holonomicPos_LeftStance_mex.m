...
J_tmp = call_mathematica_Jacobian('holConstrPosition_toebottomleftback', J_tmp, [q,h3], 0);
% Construct Full Jacobian
...
J_tmp = call_mathematica_Jacobian('holConstrPosition_toebottomleftfront', J_tmp, [q,h4], 0);
% Construct Full Jacobian
