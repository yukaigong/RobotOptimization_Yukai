...
% Also create the same function for foot clearance (just for easy
% readability)
symbolicToFunction(['f_swingFootClearance_',domainName], {vars,extra}, {constraint}, OPT_PATH)
symbolicToFunction(['J_swingFootClearance_',domainName], {vars,extra}, {J_constraint}, OPT_PATH)
